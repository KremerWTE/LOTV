...
**Last Updated**: 2026-09-14 (session 5 — Serilog config-driven, CORS open, CI/CD pipeline hardened)
...
- [x] Structured logging (Serilog) — fully config-driven via appsettings per environment; Dev: console/Debug; Staging: console+file; Production: console(Warning+)+file(Info+)+MSSqlServer(Warning+, auto-creates dbo.AppLogs)
